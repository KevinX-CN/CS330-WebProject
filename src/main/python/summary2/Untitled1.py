...
if __name__ == '__main__':
    ...
    #     S.train()
    text = """在认真听取大家发言后，李鹏宇做了总结。他表示，今年是新中国成立70周年，也是全面建成小康社会、实现第一个百年奋斗目标的关键之年。今年以来，面对纷繁复杂的国际国内形势，我们要好好学习贯彻新发展理念，统筹推进稳增长、促改革、调结构、惠民生、防风险、保稳定各项工作。经济运行总体平稳、稳中有进，经济高质量发展取得新的进展。"""
    S.summary(text)